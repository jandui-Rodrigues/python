from exercicios import divisible_by_three_or_five, validate_email
import pytest


def test_fizzbuzz_should_return_list_of_numbers():
    assert divisible_by_three_or_five(2) == [1, 2]


def test_fizzbuzz_divisible_by_three_should_be_fizz():
    assert divisible_by_three_or_five(3)[-1] == "Fizz"


def test_fizzbuzz_divisible_by_five_should_be_buzz():
    assert divisible_by_three_or_five(5)[-1] == "Buzz"


def test_fizzbuzz_divisible_by_five_and_three_should_be_fizzbuzz():
    assert divisible_by_three_or_five(15)[-1] == "FizzBuzz"
