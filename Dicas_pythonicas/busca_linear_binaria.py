...
# print(">> Tempo de execução para busca linear em 10000000 elementos: "
#  + str(timeit(lambda: BuscaLinear(lista_dez_milhoes, alvo_dez_milhoes),
# number=1)))
# print(">> Tempo de execução para busca linear em 1000000000 elementos: " +
#  str(timeit(lambda: BuscaLinear(lista_bilhao, alvo_bilhao), number=1)))
...
# print(">> Tempo de execução para busca binária em 10000000 elementos: " +
#  str(timeit(lambda: BuscaBinaria(lista_dez_milhoes, alvo_dez_milhoes),
#  number=1)))
# print(">> Tempo de execução para busca binária em 1000000000 elementos: " +
# str(timeit(lambda: BuscaLinear(lista_bilhao, alvo_bilhao), number=1)))
